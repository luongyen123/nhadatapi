...
<html lang="">
	<head>
		...
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="{{asset('../dist/css/boostrap3_6.min.css')}}" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous">
